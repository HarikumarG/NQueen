...
public class seven_queen extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_queen);
        ...
        AlertDialog dialog = new AlertDialog.Builder(seven_queen.this)
                .setTitle("Note:\n")
                    ...
                    if (Utility.checkattack(board, n, 0, 0) == false) {
                        ...
                        if (queencount == n) {
                            ...
                            next.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent nextlevel = new Intent("com.example.harikumarg.n_queen.eight_queen");
